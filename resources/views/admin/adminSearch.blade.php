...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('./assets/css/adminSearchProduct.css') }}">
</head>
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <div class="container-fluid">
        ...
        <!-- SỬA: Khối tìm kiếm đã được cập nhật -->
            ...
            <div class="card-body">
                <form action="{{ url('adminSearchProducts') }}" method="GET" class="w-100">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control" placeholder="Tìm kiếm theo tên, danh mục, thương hiệu..." value="{{ request('search') }}">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Kết quả tìm kiếm cho: "{{ request('search') }}"</h6>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover" id="dataTable" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- SỬA: Thêm các nút thao tác kho hàng -->
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center">Không tìm thấy sản phẩm nào phù hợp.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
